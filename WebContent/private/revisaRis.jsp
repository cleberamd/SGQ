...
<div class="col-md-9">
  ...
  <div class="panel-body">
    <p>SISTEMA DA QUALIDADE - REGISTRO DE INSPEÇÃO DE SERVIÇOS</p>
  	...
  	<form method="post" action="RISController?action=revisaoSalvar&RisId=<%=r.getId() %>"   >
  	<div class= "table">
    ...
    <table class="table " >         
        <thead >
           ...
           TITULO
            ...
            <th>
            	<input  type="number" class="form-control"  value="<%=r.getNumero() %>" name="RisNum" disabled="disabled">
            </th>
            <th>
             <input type="text" class="form-control"  value="<%=r.getNome() %>" name="Titulo" disabled="disabled">
            </th>
