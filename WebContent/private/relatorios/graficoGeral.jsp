...
<body style="background-color: #EEE;">
	...
	<div class="container" >
<!-- ----------------------------------------------------------------------------------------------------------------------------------- -->
<form method="post" action="ReportServlet?action=rel&relName=graficoG"
		name="meu_form">
<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">GRÁFICO GERAL DAS CONFORMIDADES </h3>
			</div>
...
<div class="col-md-4">
 ...
 <div class="input-group">
				<span class="input-group-addon" id="basic-addon1">Nome da Obra</span> <input
					...
					placeholder="TODAS" name="obraNome" disabled aria-describedby="basic-addon1" >
