...
var url_mobile = "UsuarioController?action=mobile";
(function(a,b){
...
<jsp:include page="importsMenu.jspf"></jsp:include>
...
$(function(){
	...
	var textfield = $("input[name=usuario]");
	            ...
	            if (msm=="erroLogin") {
                    ...
                    $("#output").addClass("alert alert-danger animated fadeInUp").html("Desculpe verifique o usuario e senha ");
...
<body>
	...
	<div class="login-container">
            ...
            <div class="form-box">
        <form class="form-signin" id="myForm" action="UsuarioController?action=login" method="post">
