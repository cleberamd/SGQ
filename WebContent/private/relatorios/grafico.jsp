...
<body style="background-color: #EEE;">
	...
	<div class="container" >
<!-- ----------------------------------------------------------------------------------------------------------------------------------- -->
<form method="post" action="ReportServlet?action=rel&relName=grafico3"
		name="meu_form">
<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">GRAFICO DE CONFORMIDADES</h3>
			</div>
...
<div class="col-md-4">
 ...
 <div class="input-group">
				<span class="input-group-addon" id="basic-addon1">Nome da obra</span> <input
					...
					placeholder="Nome da obra ou %" name="obraNome" aria-describedby="basic-addon1" required>
